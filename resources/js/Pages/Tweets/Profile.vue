    ...
    <AppLayout title="Profile">
        <template #header>
           <div class="flex items-center justify-between">
                ...
                <div v-if="profileUser.id !== $page.props.user.id">
                    <Link v-if="!profileUser.is_followed" as="button" :href="`/follows/${profileUser.id}`" method="POST"
        ...
        <div class="py-12">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <div v-for="tweet in tweets" v-bind:key="tweet.id" class="flex items-center space-x-4
